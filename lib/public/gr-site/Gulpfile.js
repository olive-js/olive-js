...
gulp.task('styles', ['clean'], stylesCss);
gulp.task('styles-watch', stylesCss);
...
gulp.task('build', ['images', 'styles', 'scripts', 'fonts', 'metalsmith']);
gulp.task('build:prod', ['images', 'styles', 'scripts', 'fonts', 'metalsmith:prod']);
